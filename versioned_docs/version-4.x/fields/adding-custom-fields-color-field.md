<!-- Filename: J3.x:Adding_custom_fields/Color_Field / Display title: Adding custom fields/Color Field -->
...
id="content-button" class="button expand success">Prev: Checkboxes
Field</a>
<a href="https://docs.joomla.org/J3.x:Adding_custom_fields/Editor_Field"
id="content-button" class="button expand">Next: Editor Field</a>
